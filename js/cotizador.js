(function(){
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        // * Mostramos los días seleccionados que se regresan de la BD (solo funciona en editar-registrados.php):
        var formulario_editar = document.getElementsByClassName('editar-registrados');
        ...
        // !moví el mapa al archivo main, aquí no funciona
