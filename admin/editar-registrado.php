...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Edita Registrados a los eventos<small></small></h1>
  </section>
      ...
      <section class="content">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edita Registrado.</h3>
          </div>
          ...
          ?>
            ...
            <form class="editar-registrados" role="form" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-registrado.php">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="<?php echo $registrados['nombre_registrado'] ?>">
                </div>

                <div class="form-group">
                  <label for="apellido_registrado">Apellido:</label>
                  <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Apellido" value="<?php echo $registrados['apellido_registrado'] ?>">
                </div>

                <div class="form-group">
                  <label for="email">email:</label>
                  <input type="email" class="form-control" id="email" name="email" placeholder="email" value="<?php echo $registrados['email_registrado'] ?>">
                </div>
                      ...
                      <li class="col-md-4">
                        <div class="tabla-precio text-center">
                          ...
                          <div class="orden">
                            ...
                            <input type="number" class="form-control" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0" value="<?php echo $boletos['un dia']['cantidad'] ?>">
                      ...
                      <li class="col-md-4">
                        <div class="tabla-precio text-center">
                          ...
                          <div class="orden">
                            ...
                            <input type="number" class="form-control" min="0" id="pase_dos_dias" size="3" name="boletos[dos_dias][cantidad]" placeholder="0" value="<?php echo $boletos['pase_2dias']['cantidad'] ?>">
                      ...
                      <li class="col-md-4">
                        <div class="tabla-precio text-center">
                          ...
                          <div class="orden">
                            ...
                            <input type="number" class="form-control" min="0" id="pase_completo" size="3" name="boletos[pase_completo][cantidad]" placeholder="0" value="<?php echo $boletos['pase_completo']['cantidad'] ?>">
                    ...
                    <div id="resumen" class="resumen clearfix">
                      ...
                      <div class="caja clearfix row">
                        ...
                        <div class="total col-md-6">
                          ...
                          <p>Total ya pagado: <?php echo $registrados['total_pagado'] ?></p>
                          <p>Total:</p>
                          <div id="suma_total">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btnRegistro">Guardar Registro</button>
              </div>
